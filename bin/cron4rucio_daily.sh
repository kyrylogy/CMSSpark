...
# /cms/rucio_daily/rucio
# Average directory size is 80MB, so we can give 50Mb, in bytes 50000000

current_date_hdfs="$(date +%Y/%m/%d)"
/bin/bash "$script_dir"/utils/check_utils.sh check_hdfs "$OUTPUT_DIR"/rucio/"$current_date_hdfs" 43200 50000000
